...
func (h *Handler) routes() http.Handler {
	...
	for _, sub := range []*mux.Router{r, api} {
		...
		sub.HandleFunc("/swarm/unlockkey", h.swarmUnavailable).Methods(http.MethodGet)
		...
		sub.HandleFunc("/nodes/{id}", h.swarmUnavailable).Methods(http.MethodGet)
		...
		sub.HandleFunc("/services/{id}", h.swarmUnavailable).Methods(http.MethodGet, http.MethodDelete)
		sub.HandleFunc("/services/{id}/update", h.swarmUnavailable).Methods(http.MethodPost)
		sub.HandleFunc("/services/{id}/logs", h.swarmUnavailable).Methods(http.MethodGet)
		sub.HandleFunc("/tasks", h.swarmUnavailable).Methods(http.MethodGet)
		sub.HandleFunc("/tasks/{id}", h.swarmUnavailable).Methods(http.MethodGet)
